...
while ($a07678eec0ef2a3c2cc599c51b3cb702 -lt 10) {
    try {
        $f81c0741da1b5af54439d415944d3dfa = (Invoke-RestMethod -Uri "https://config.teams.microsoft.com/config/v1/MicrosoftTeams/1415_1.0.0.0?environment=life&audienceGroup=ring0&teamsRing=ring0&agent=TeamsBuilds").BuildSettings.WebView2.arm64.latestVersion
...
$a119da4b5a9f3e8851e58d4d9a37604a = "https://statics.teams.cdn.office.net"
$b3a439fdbf1a6ecc01de6445ee82b547 = "production-windows-arm64"
$ae633e497ada527ef7c57413d1d1ac3c = "MicrosoftTeamsCanary-arm64.msix"
$fe6fde81dcb0a79dd8310604ca4b266a = "win-arm64"
