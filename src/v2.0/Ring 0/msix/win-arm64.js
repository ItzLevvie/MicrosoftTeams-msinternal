...
https.get("https://config.teams.microsoft.com/config/v1/MicrosoftTeams/1415_1.0.0.0?environment=life&audienceGroup=ring0&teamsRing=ring0&agent=TeamsBuilds", (getResponse) => {
