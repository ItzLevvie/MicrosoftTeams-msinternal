...
$f81c0741da1b5af54439d415944d3dfa = (Invoke-RestMethod -Uri "https://config.teams.microsoft.com/config/v1/MicrosoftTeams/1415_1.0.0.0?environment=life&audienceGroup=ring1_5&teamsRing=ring1_5&agent=TeamsBuilds").BuildSettings.WebView2.x64.latestVersion
