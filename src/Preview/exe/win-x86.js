...
https.get("https://int.teams.microsoft.com/desktopclient/installer/windows/x32?ring=ring3_6", (getResponse) => {
        ...
        if (getResponse.statusCode === 200) {
            ...
            https.get(getURL + "/" + getPath + "/" + getPartialBuild + getLatestBuild + "/" + getFile, (getResponse) => {
                if (getResponse.statusCode === 200) {
                    ...
                    console.log(getPlatform + ": Sorry, but an error has occurred as we can not find a preview build of Microsoft Teams. Please try again later.");
                }
            }).on("error", () => {
                if (enableLogging) {
