...
for (($fda625b81e647d7c6acd91aed9ae8ecd = [int](Get-Content -Path "..\..\.github\ci\v1.0\Exploration\pkg\$fe6fde81dcb0a79dd8310604ca4b266a.txt")), ($f62d19962ff48160c9e1e0332e7ef11c = $fda625b81e647d7c6acd91aed9ae8ecd + 512); $fda625b81e647d7c6acd91aed9ae8ecd -le $f62d19962ff48160c9e1e0332e7ef11c; $fda625b81e647d7c6acd91aed9ae8ecd++) {
    if ($fda625b81e647d7c6acd91aed9ae8ecd -match "^([0-9][0-9][0-9][0-4][0-9])$") {
        ...
        if ($ab3b0e88a3e2899c2990b7cab3d3c26f) {
            ...
            if ($d576b5bca1bedfb596e11dd14013fa64 -ge 200) {
