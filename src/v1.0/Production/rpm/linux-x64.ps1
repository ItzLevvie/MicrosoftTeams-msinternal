...
while ($a07678eec0ef2a3c2cc599c51b3cb702 -lt 5) {
    try {
        $ae633e497ada527ef7c57413d1d1ac3c = (Invoke-WebRequest -Uri "$a119da4b5a9f3e8851e58d4d9a37604a$b3a439fdbf1a6ecc01de6445ee82b547" -Method Get).Links.href -match "teams-1.5.00.\d{5}" | Select-Object -Last 1
        $f81c0741da1b5af54439d415944d3dfa = $ae633e497ada527ef7c57413d1d1ac3c.TrimStart("teams-").TrimEnd("-1.x86_64.rpm")
