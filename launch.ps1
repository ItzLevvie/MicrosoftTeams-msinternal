...
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring ring0 -Platform win-x64 -Version 1.0 -Type Desktop -ObjectId 3a7cf1d3-06fa-4ead-bf45-a6286ff2620a -TenantId 72f988bf-86f1-41af-91ab-2d7cd011db47
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring ring0 -Platform win-x86 -Version 1.0 -Type Desktop -ObjectId 3a7cf1d3-06fa-4ead-bf45-a6286ff2620a -TenantId 72f988bf-86f1-41af-91ab-2d7cd011db47
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring ring0 -Platform win-arm64 -Version 1.0 -Type Desktop -ObjectId 3a7cf1d3-06fa-4ead-bf45-a6286ff2620a -TenantId 72f988bf-86f1-41af-91ab-2d7cd011db47
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring ring0 -Platform "osx-x64 + osx-arm64" -Version 1.0 -Type Desktop -ObjectId 3a7cf1d3-06fa-4ead-bf45-a6286ff2620a -TenantId 72f988bf-86f1-41af-91ab-2d7cd011db47
Write-Output ""
...
Write-Output ""
Write-Output "  Teams 1.0 — Microsoft Teams classic (work or school):"
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring ring0_s -Platform win-x64 -Version 1.0 -Type Desktop -ObjectId 3a7cf1d3-06fa-4ead-bf45-a6286ff2620a -TenantId 72f988bf-86f1-41af-91ab-2d7cd011db47
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring ring0_s -Platform win-x86 -Version 1.0 -Type Desktop -ObjectId 3a7cf1d3-06fa-4ead-bf45-a6286ff2620a -TenantId 72f988bf-86f1-41af-91ab-2d7cd011db47
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring ring0_s -Platform win-arm64 -Version 1.0 -Type Desktop -ObjectId 3a7cf1d3-06fa-4ead-bf45-a6286ff2620a -TenantId 72f988bf-86f1-41af-91ab-2d7cd011db47
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring ring0_s -Platform "osx-x64 + osx-arm64" -Version 1.0 -Type Desktop -ObjectId 3a7cf1d3-06fa-4ead-bf45-a6286ff2620a -TenantId 72f988bf-86f1-41af-91ab-2d7cd011db47
Write-Output ""
Write-Output "  Teams 2.0 — Microsoft Teams (free):"
...
Write-Output ""
Write-Output "  Teams 1.0 — Microsoft Teams classic (work or school):"
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring ring1 -Platform win-x64 -Version 1.0 -Type Desktop -ObjectId 3a7cf1d3-06fa-4ead-bf45-a6286ff2620a -TenantId 72f988bf-86f1-41af-91ab-2d7cd011db47
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring ring1 -Platform win-x86 -Version 1.0 -Type Desktop -ObjectId 3a7cf1d3-06fa-4ead-bf45-a6286ff2620a -TenantId 72f988bf-86f1-41af-91ab-2d7cd011db47
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring ring1 -Platform win-arm64 -Version 1.0 -Type Desktop -ObjectId 3a7cf1d3-06fa-4ead-bf45-a6286ff2620a -TenantId 72f988bf-86f1-41af-91ab-2d7cd011db47
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring ring1 -Platform "osx-x64 + osx-arm64" -Version 1.0 -Type Desktop -ObjectId 3a7cf1d3-06fa-4ead-bf45-a6286ff2620a -TenantId 72f988bf-86f1-41af-91ab-2d7cd011db47
Write-Output ""
Write-Output "  Teams 2.0 — Microsoft Teams (free):"
...
Write-Output ""
Write-Output "  Teams 1.0 — Microsoft Teams classic (work or school):"
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring ring1_5 -Platform win-x64 -Version 1.0 -Type Desktop -ObjectId 3a7cf1d3-06fa-4ead-bf45-a6286ff2620a -TenantId 72f988bf-86f1-41af-91ab-2d7cd011db47
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring ring1_5 -Platform win-x86 -Version 1.0 -Type Desktop -ObjectId 3a7cf1d3-06fa-4ead-bf45-a6286ff2620a -TenantId 72f988bf-86f1-41af-91ab-2d7cd011db47
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring ring1_5 -Platform win-arm64 -Version 1.0 -Type Desktop -ObjectId 3a7cf1d3-06fa-4ead-bf45-a6286ff2620a -TenantId 72f988bf-86f1-41af-91ab-2d7cd011db47
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring ring1_5 -Platform "osx-x64 + osx-arm64" -Version 1.0 -Type Desktop -ObjectId 3a7cf1d3-06fa-4ead-bf45-a6286ff2620a -TenantId 72f988bf-86f1-41af-91ab-2d7cd011db47
Write-Output ""
Write-Output "  Teams 2.0 — Microsoft Teams (free):"
...
Write-Output ""
Write-Output "  Teams 1.0 — Microsoft Teams classic (work or school):"
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring ring1_6 -Platform win-x64 -Version 1.0 -Type Desktop -ObjectId 3a7cf1d3-06fa-4ead-bf45-a6286ff2620a -TenantId 72f988bf-86f1-41af-91ab-2d7cd011db47
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring ring1_6 -Platform win-x86 -Version 1.0 -Type Desktop -ObjectId 3a7cf1d3-06fa-4ead-bf45-a6286ff2620a -TenantId 72f988bf-86f1-41af-91ab-2d7cd011db47
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring ring1_6 -Platform win-arm64 -Version 1.0 -Type Desktop -ObjectId 3a7cf1d3-06fa-4ead-bf45-a6286ff2620a -TenantId 72f988bf-86f1-41af-91ab-2d7cd011db47
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring ring1_6 -Platform "osx-x64 + osx-arm64" -Version 1.0 -Type Desktop -ObjectId 3a7cf1d3-06fa-4ead-bf45-a6286ff2620a -TenantId 72f988bf-86f1-41af-91ab-2d7cd011db47
Write-Output ""
Write-Output "  Teams 2.0 — Microsoft Teams (free):"
...
Write-Output ""
Write-Output "  Teams 1.0 — Microsoft Teams classic (work or school):"
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring ring2 -Platform win-x64 -Version 1.0 -Type Desktop -ObjectId 3a7cf1d3-06fa-4ead-bf45-a6286ff2620a -TenantId 72f988bf-86f1-41af-91ab-2d7cd011db47
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring ring2 -Platform win-x86 -Version 1.0 -Type Desktop -ObjectId 3a7cf1d3-06fa-4ead-bf45-a6286ff2620a -TenantId 72f988bf-86f1-41af-91ab-2d7cd011db47
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring ring2 -Platform win-arm64 -Version 1.0 -Type Desktop -ObjectId 3a7cf1d3-06fa-4ead-bf45-a6286ff2620a -TenantId 72f988bf-86f1-41af-91ab-2d7cd011db47
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring ring2 -Platform "osx-x64 + osx-arm64" -Version 1.0 -Type Desktop -ObjectId 3a7cf1d3-06fa-4ead-bf45-a6286ff2620a -TenantId 72f988bf-86f1-41af-91ab-2d7cd011db47
Write-Output ""
Write-Output "  Teams 2.0 — Microsoft Teams (free):"
...
Write-Output ""
Write-Output "  Teams 1.0 — Microsoft Teams classic (work or school):"
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring ring3 -Platform win-x64 -Version 1.0 -Type Desktop -ObjectId 3a7cf1d3-06fa-4ead-bf45-a6286ff2620a -TenantId 72f988bf-86f1-41af-91ab-2d7cd011db47
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring ring3 -Platform win-x86 -Version 1.0 -Type Desktop -ObjectId 3a7cf1d3-06fa-4ead-bf45-a6286ff2620a -TenantId 72f988bf-86f1-41af-91ab-2d7cd011db47
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring ring3 -Platform win-arm64 -Version 1.0 -Type Desktop -ObjectId 3a7cf1d3-06fa-4ead-bf45-a6286ff2620a -TenantId 72f988bf-86f1-41af-91ab-2d7cd011db47
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring ring3 -Platform "osx-x64 + osx-arm64" -Version 1.0 -Type Desktop -ObjectId 3a7cf1d3-06fa-4ead-bf45-a6286ff2620a -TenantId 72f988bf-86f1-41af-91ab-2d7cd011db47
Write-Output ""
Write-Output "  Teams 2.0 — Microsoft Teams (free):"
...
Write-Output ""
Write-Output "  Teams 1.0 — Microsoft Teams classic (work or school):"
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring ring3_6 -Platform win-x64 -Version 1.0 -Type Desktop
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring ring3_6 -Platform win-x86 -Version 1.0 -Type Desktop
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring ring3_6 -Platform win-arm64 -Version 1.0 -Type Desktop
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring ring3_6 -Platform "osx-x64 + osx-arm64" -Version 1.0 -Type Desktop
Write-Output ""
Write-Output "  Teams 2.0 — Microsoft Teams (free):"
...
Write-Output ""
Write-Output "  Teams 1.0 — Microsoft Teams classic (work or school):"
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring ring3_9 -Platform win-x64 -Version 1.0 -Type Desktop -ObjectId 3a7cf1d3-06fa-4ead-bf45-a6286ff2620a -TenantId 72f988bf-86f1-41af-91ab-2d7cd011db47
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring ring3_9 -Platform win-x86 -Version 1.0 -Type Desktop -ObjectId 3a7cf1d3-06fa-4ead-bf45-a6286ff2620a -TenantId 72f988bf-86f1-41af-91ab-2d7cd011db47
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring ring3_9 -Platform win-arm64 -Version 1.0 -Type Desktop -ObjectId 3a7cf1d3-06fa-4ead-bf45-a6286ff2620a -TenantId 72f988bf-86f1-41af-91ab-2d7cd011db47
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring ring3_9 -Platform "osx-x64 + osx-arm64" -Version 1.0 -Type Desktop -ObjectId 3a7cf1d3-06fa-4ead-bf45-a6286ff2620a -TenantId 72f988bf-86f1-41af-91ab-2d7cd011db47
Write-Output ""
Write-Output "  Teams 2.0 — Microsoft Teams (free):"
...
Write-Output ""
Write-Output "  Teams 1.0 — Microsoft Teams classic (work or school):"
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring general -Platform win-x64 -Version 1.0 -Type Desktop
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring general -Platform win-x86 -Version 1.0 -Type Desktop
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring general -Platform win-arm64 -Version 1.0 -Type Desktop
& ".\Get-MicrosoftTeams.ps1" -Environment prod -Ring general -Platform "osx-x64 + osx-arm64" -Version 1.0 -Type Desktop
Write-Output ""
Write-Output "  Teams 2.0 — Microsoft Teams (free):"
...
Write-Output ""
Write-Output "  Teams 1.0 — Microsoft Teams classic (work or school):"
& ".\Get-MicrosoftTeams.ps1" -Environment gcchigh -Ring general -Platform win-x64 -Version 1.0 -Type Desktop
& ".\Get-MicrosoftTeams.ps1" -Environment gcchigh -Ring general -Platform win-x86 -Version 1.0 -Type Desktop
& ".\Get-MicrosoftTeams.ps1" -Environment gcchigh -Ring general -Platform win-arm64 -Version 1.0 -Type Desktop
& ".\Get-MicrosoftTeams.ps1" -Environment gcchigh -Ring general -Platform "osx-x64 + osx-arm64" -Version 1.0 -Type Desktop
Write-Output ""
Write-Output "  Teams 2.1 — Microsoft Teams (work or school):"
...
Write-Output ""
Write-Output "  Teams 1.0 — Microsoft Teams classic (work or school):"
& ".\Get-MicrosoftTeams.ps1" -Environment dod -Ring general -Platform win-x64 -Version 1.0 -Type Desktop
& ".\Get-MicrosoftTeams.ps1" -Environment dod -Ring general -Platform win-x86 -Version 1.0 -Type Desktop
& ".\Get-MicrosoftTeams.ps1" -Environment dod -Ring general -Platform win-arm64 -Version 1.0 -Type Desktop
& ".\Get-MicrosoftTeams.ps1" -Environment dod -Ring general -Platform "osx-x64 + osx-arm64" -Version 1.0 -Type Desktop
Write-Output ""
Write-Output "  Teams 2.1 — Microsoft Teams (work or school):"
...
Write-Output ""
Write-Output "  Teams 1.0 — Microsoft Teams classic (work or school):"
& ".\Get-MicrosoftTeams.ps1" -Environment gallatin -Ring general -Platform win-x64 -Version 1.0 -Type Desktop
& ".\Get-MicrosoftTeams.ps1" -Environment gallatin -Ring general -Platform win-x86 -Version 1.0 -Type Desktop
& ".\Get-MicrosoftTeams.ps1" -Environment gallatin -Ring general -Platform win-arm64 -Version 1.0 -Type Desktop
& ".\Get-MicrosoftTeams.ps1" -Environment gallatin -Ring general -Platform "osx-x64 + osx-arm64" -Version 1.0 -Type Desktop
Write-Output ""
Write-Output "  Teams 2.1 — Microsoft Teams (work or school):"
