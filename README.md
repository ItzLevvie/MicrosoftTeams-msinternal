...
| id | Your Azure Active Directory (AAD) ID. <br> <br> This repository uses `3a7cf1d3-06fa-4ead-bf45-a6286ff2620a` as the Azure Active Directory (AAD) ID which is one of our Microsoft employees who is the `Director of Product Marketing for Microsoft 365` and runs Canary (R0) builds for Microsoft Teams on a daily basis. |
| aaduserid | Your Azure Active Directory (AAD) ID. <br> <br> This repository uses `3a7cf1d3-06fa-4ead-bf45-a6286ff2620a` as the Azure Active Directory (AAD) ID which is one of our Microsoft employees who is the `Director of Product Marketing for Microsoft 365` and runs Canary (R0) builds for Microsoft Teams on a daily basis. |
