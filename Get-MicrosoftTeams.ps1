...
elseif ($EnvironmentType -eq "life") {
    $dce146e66b2e5c0e104729239cc1ae15 = "https://config.teams.microsoft.com"
}
elseif ($EnvironmentType -eq "gcchigh") {
    $dce146e66b2e5c0e104729239cc1ae15 = "https://config.ecs.gov.teams.microsoft.us"
}
elseif ($EnvironmentType -eq "dod") {
    $dce146e66b2e5c0e104729239cc1ae15 = "https://config.ecs.dod.teams.microsoft.us"
}
elseif ($EnvironmentType -eq "gallatin") {
    $dce146e66b2e5c0e104729239cc1ae15 = "https://mooncake.config.teams.microsoft.com"
}

#
if ($RingType -eq "ring0") {
    $e783048973935431707b367c535d6ea4 = "https://staticsint.teams.cdn.office.net"
}
elseif ($RingType -eq "ring0_s") {
    $e783048973935431707b367c535d6ea4 = "https://staticsint.teams.cdn.office.net"
}
elseif ($RingType -eq "ring1") {
    $e783048973935431707b367c535d6ea4 = "https://staticsint.teams.cdn.office.net"
}
elseif ($RingType -eq "ring1_5") {
    $e783048973935431707b367c535d6ea4 = "https://statics.teams.cdn.office.net"
}
elseif ($RingType -eq "ring1_6") {
    $e783048973935431707b367c535d6ea4 = "https://statics.teams.cdn.office.net"
}
elseif ($RingType -eq "ring2") {
    $e783048973935431707b367c535d6ea4 = "https://statics.teams.cdn.office.net"
}
elseif ($RingType -eq "ring3") {
    $e783048973935431707b367c535d6ea4 = "https://statics.teams.cdn.office.net"
}
elseif ($RingType -eq "ring3_6") {
    $e783048973935431707b367c535d6ea4 = "https://statics.teams.cdn.office.net"
}
elseif ($RingType -eq "ring3_9") {
    $e783048973935431707b367c535d6ea4 = "https://statics.teams.cdn.office.net"
}
elseif ($RingType -eq "general") {
    $e783048973935431707b367c535d6ea4 = "https://statics.teams.cdn.office.net"
}
elseif ($RingType -eq "general_gcc") {
    $e783048973935431707b367c535d6ea4 = "https://statics.teams.cdn.office.net"
}
...
while ($e49bb609ef26353d2c308ca6beb0de8f -le 32) {
    try {
        ...
        if ($a553ddde23e7dad4144c98d2e342ba31) {
            ...
            Write-Output "  $a553ddde23e7dad4144c98d2e342ba31 ($PlatformType) - published on $e1e240488e5eef1f776376b0ebf7609a with $e0167d390ca0b503d10f31ed2ded6eb4 MB: $e783048973935431707b367c535d6ea4/$bd3078f40b0117196fdb4853563084e9/$a553ddde23e7dad4144c98d2e342ba31/$e7782dde7d9e6e4f63894a63138afbb9"
        }
        break
    }
    catch {
